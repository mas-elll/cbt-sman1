                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $mapels }}</div>
                                </div>
                                <div class="col">
            ...
            <div class="card shadow h-100">
                ...
                <div class="card-body">
                    <div class="chart-area">
                        <h5 class="mb-2">Selamat Datang Admin</h5>
                        <p class="lead mb-4">Sistem informasi pengelolaan penugasan SMAN 1 BANTUL</p>
                        <ul class="list-group">
                            <li class="list-group-item"><p class="lead">Admin dapat mengelola pengguna Guru dan Siswa</p></li>
                            <li class="list-group-item"><p class="lead">Admin dapat mengelola Kelas dan Mata Pelajaran</p></li>
                            <li class="list-group-item"><p class="lead">Admin dapat melihat data Penugasan</p></li>
                            <li class="list-group-item"><p class="lead">Admin dapat mencetak hasil Laporan</p></li>
                        </ul>
                    </div>
                </div>
            </div>
